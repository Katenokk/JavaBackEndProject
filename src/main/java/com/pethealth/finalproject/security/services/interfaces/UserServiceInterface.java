...
//    List<User> getUsers();
    ...
    void partialUpdateOwner(Long id, String name, String username, String password);

    void partialUpdateVeterinarian(Long id, String name, String password, String email);

    void partialUpdateAdmin(Long id, String name, String password);
